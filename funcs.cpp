...
void menu() {
    ...
    cout << "2)Добавить студента c должностью\n";
    cout << "3)Вывод студентов группы\n";
    cout << "4)Вывод студентов группы в файл\n";
    cout << "5)Ввод студентов из файла\n";
    cout << "6)Очистка списка студентов\n";
    cout << "0)Выход\n";
}
